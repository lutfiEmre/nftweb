...
const TurnLife = () => {
    ...
    return (
        <div className="min-h-[70vh] flex flex-col-reverse  mb-[100px] lg:flex-row justify-center items-center gap-[50px] sm:gap-[100px] xl:gap-[150px]   lg:mt-[1vw] 2xl:mt-[2vw]">
