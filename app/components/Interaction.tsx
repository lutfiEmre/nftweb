...
const Interaction = () => {
    return (
        <div
            className="  justify-center px-[40px] items-center flex flex-col bg3 to-[#162447] gap-y-[50px]    py-[40px]">
            <h6 className={'text-[36px] text-center md:text-[48px] lg:text-[64px] jost-semibold text-white'}>
