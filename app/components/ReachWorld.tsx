...
const ReachWorld = () => {
    return (
        <div className={'mt-[128px] flex flex-col lg:flex-row justify-center items-center gap-[80px]'}>
            <Image className={'w-full h-full max-w-[500px] rotate-animation md:w-[350px] lg:w-[765px] max-h-[500px] lg:h-[483px]'} width={765} height={483} src={worldsvg} alt={'world svg'}/>
            <div className={'flex flex-col gap-[16px]'}>
                <h3 className={'inter-semibold text-[#FF00CC] text-[18px]'}>
                    Reach the Whole World
                </h3>
                <h2 className={'jost-semibold text-white text-[36px]'}>
                    Reach Global Audiences with Innovative Advertising on Activate Earth
                </h2>
                <h5 className={'mt-[34px] rubik-regular text-[20px] text-white text-opacity-80'}>
